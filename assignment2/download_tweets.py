...
if __name__ == "__main__":
    ...
    parser.add_argument("--user_file", help="file with legislators' twitter information", required=True)
    ...
    try:
        ...
        for user_id in user_df['twitter_id']:
          ...
          eprint("Getting last 7 days of tweet for user: " + str(user_id))
          paginator = Paginator(twitter_client.get_users_tweets,
            id=user_id,
            exclude=['retweets', 'replies'],
            expansions='author_id',
            tweet_fields=['conversation_id', 'created_at', 'public_metrics'],
            user_fields='public_metrics',
            start_time=(datetime.datetime.now() - datetime.timedelta(days=7)),
            max_results=100,                       # How many tweets per page
            limit=3                                # How many pages to retrieve
          )
